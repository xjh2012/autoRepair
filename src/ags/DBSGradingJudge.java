...
public class DBSGradingJudge{
    ...
    public DBSGradingJudge(String assignmentId, File binFile, String[] inputs, String[] outputs, 
            DbListener dbListener, PrintWriter pw){
        this.assignmentId = Integer.parseInt(assignmentId);
        dbl = dbListener;
        out = pw;
    ...
    public DBSGradingJudge(String assignmentId, File binFile, String[] input, String[] output, int numTestCase, PrintWriter pw) {
	...
	public void executeTests(){
        String exResult="";
        if(compiled){
            TestExecutor testExec = new TestExecutor(strShell, inputs, numTestCase);
        ...
        String queryAnswer = "UPDATE gradingsystem.answer SET ex_status = \'Complete\'"
            +", status = \'"+exResult+"\'  where answer.an_id = "+ assignmentId;
